  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="address in addressInfo" :key='address.id'>
        ...
        <p @click="defaultAddress(address,addressInfo)">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="d in orderInfo.detailArrayList" :key='d.skuid'>
          <li>
            <img :src="d.imgUrl" style="width:100px">
          </li>
          <li>
            <p>
            {{d.skuName}}</p>
...
import {mapState} from 'vuex'
  export default {
    ...
    methods:{
      defaultAddress(address,addressInfo){
        //排他性
