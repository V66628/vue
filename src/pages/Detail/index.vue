          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="attr in detailInfo.spuSaleAttrList" :key='attr.id'>
                ...
                <dd changepirce="0" :class="{active:Number(s.isChecked)}" v-for="s in attr.spuSaleAttrValueList" :key='s.id' @click="changeActive(s,attr.spuSaleAttrValueList)">{{s.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
...
<script>
  ...
  export default {
    ...
    computed:{
      ...
      skuImageList(){
        const skuInfo=this.detailInfo.skuInfo || {}
    ...
    async  addCar(){
             try {
               await  this.$store.dispatch('detail/addShopCar',{skuid:this.$route.params.skuid,skumNum:this.skunum})
