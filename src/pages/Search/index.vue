        ...
        <div class="details clearfix">
                  ...
                  <a
                    ...
                    <span
                      ...
                      :class="{
                        ...
                        'el-icon-top': searchParams.order.indexOf('asc') != -1,
                      }"
                    ></span
                  ></a>
                </li>
          ...
          <div class="goods-list">
            <ul class="yui3-g">
              <li
                class="yui3-u-1-5"
                v-for="g in searchList.goodsList"
                :key="g.id"
              >
                <div class="list-wrap">
                  <div class="p-img">
                    <router-link  :to="`/detail/${g.id}`"><img v-lazy="g.defaultImg"/></router-link>
                  </div>
                  <div class="price">
                    <strong>
                      <em>¥</em>
